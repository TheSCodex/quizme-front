...
function Reset() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(import.meta.env.VITE_API_RESET, {
        method: "POST",
        headers: {
  ...
  return (
    ...
    >
      <div className="bg-white h-screen bg-opacity-[.01] backdrop-filter backdrop-blur-lg p-10 flex justify-center items-center">
        <div className="bg-white rounded-md w-[476px] h-[476px] px-16 py-10 border border-opacity-85 border-[#117ACD] flex flex-col items-center">
          ...
          <section className="form mt-8 w-full">
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-center mt-10">
                <button
                  type="submit"
                  className="w-full h-10 bg-[#117ACD] text-white rounded-md hover:bg-[#4e9bd2]"
                >
                  Reset Password
                </button>
              </div>
